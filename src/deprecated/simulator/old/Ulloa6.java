 ...
 *
 */
public class Ulloa6 extends Ulloa1 {
				...
				for (int i = 0; i < TOTAL_AGENTS; i++) {
					...
					if (/*agents_overlap != FEATURES // this is avoiding cultural change!!
						...
						if (beliefs[r][c][selected_feature] != nationality_trait || 
							...
							float cultural_factor = institutionsN[nationality] * cultural_overlap;
							...
							if (rand.nextFloat() > cultural_factor  / 
									(float) (institutionsN[neighbors_nationality] * neighbors_culture_overlap  + cultural_factor )){
