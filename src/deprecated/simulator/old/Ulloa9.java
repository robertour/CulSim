 ...
 * 3. TODO: Deterministic cultural change according to the similarity and the number of citizen's of 
 * the neighbor's culture and the agent's (the less the more resilient - minority protection)
 * @author tico
 *
 */
public class Ulloa9 extends Ulloa1 {
				...
				for (int i = 0; i < TOTAL_AGENTS; i++) {
					...
					if (/*agents_overlap != FEATURES // this is avoiding cultural change!!
						...
						if (beliefs[r][c][selected_feature] != nationality_trait || 
							...
							// to its neighbor's
							if (institutionsN[nationality] * neighbors_culture_overlap >= 
									institutionsN[neighbors_nationality] * cultural_overlap ){
