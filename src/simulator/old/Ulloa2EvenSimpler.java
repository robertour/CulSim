 ...
 *
 */
public class Ulloa2EvenSimpler extends Ulloa1 {
		...
		for (iteration = 0; iteration < ITERATIONS; iteration++) {
			for (int ic = 0; ic < CHECKPOINT; ic++) {
				for (int i = 0; i < TOTAL_AGENTS; i++) {
					...
					// let's select the features and traits
					...
					if (cultural_overlap + agents_overlap != 0) {
						// consider here the cultural shock before the interaction
						is_interaction = beliefs[r][c][selected_feature] != nationality_trait || 
