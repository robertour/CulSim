 ...
 *
 */
public class Ulloa1EAlpha extends Ulloa1D {
				...
				for (int i = 0; i < TOTAL_AGENTS; i++) {
					...
					if (/*agents_overlap != FEATURES // this is avoiding cultural change!!
						...
						if (beliefs[r][c][selected_feature] != nationality_trait || 
							...
							float cultural_factor2 = institutionsN[neighbors_nationality] * cultural_overlap;
							...
							if (rand.nextFloat() > cultural_factor2  / 
									(float) (institutionsN[nationality] * neighbors_culture_overlap  + cultural_factor2 )){
