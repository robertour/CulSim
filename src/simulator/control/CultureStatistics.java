...
/**
 * This class saves general statistics of a particular culture: the size, 
 * the geographical position, the beliefs of the culture. 
 * 
...
public class CultureStatistics implements Serializable{
	 ...
	 * 
	 * @param size size of the culture
	 * @param x x-axis of the center of the culture
	 * @param y y-axis of the center of the culture
	 * @param beliefs the beliefs of the culture
	 ...
	 * @param o the other culture
	 * @return a normalized value comparing the two positions of the cultures, 
	 * 1 for exactly the same position, and 0 for completely different positions
	 */
	 ...
	 * 
	 * @param o the other culture
	 * @return a normalized value comparing the two sizes of the cultures, 
	 * 1 for exactly the same size, and 0 for completely different sizes
	 */
	 ...
	 * 
	 * @param o the other culture
	 * @return a normalized value comparing the beliefs of the cultures, 
	 * 1 for exactly the same beliefs, and 0 for completely different beliefs
	 */
	 ...
	 * 
	 * @param o the other culture
	 * @return a normalized value comparing the two cultures, 1 for exactly the same 
	 * culture, and 0 for completely different cultures
	 */
