...
/**
 * This is the superclass for the possible events that can be introduced to
 * the simulations. Each event represent an occurrence in the simulation. It
 * could be change of parameters (e.g. change of propaganda rates) or a 
 * catastrohic event (e.g. genocide) 
 * 
...
public abstract class Event implements Serializable{
	...
	/**
	 * This represents the distribution of the event in the grid, it could be
	...
	/**
	 * It execute the event accordint to the respective distribution of the event.
	 * @param s simulation in which the event will be executed
	 */
	 ...
	 * @param p probability of the event 
	 * @param simulation simulation in which the event would occur
	 */
	 ...
	 * the (x, y) cell. This cell receives a maximum probability (1.0), and
	 * the rest a probability that is proportional to the normal distribution nd.
	 * 
	 * @param nd the probabilities of the event happening are distributed proportionally
	 * to this distribution
	 * @param x row in which the distribution is centered
	 * @param y column in which the distribution is centered
	 * @param s simulation in which the even occurs
	 */
	...
	/**
	 * The event is distributed in a Newmann's neighborhood which radious is specified
	 * by the parameter radious. The distribution is centered in r, c.
	 * 
	 * @param r the row in which this distribution will be centered
	 * @param c the column in which this distribution will be centered
	 * @param radius the radious of the Newmann's neighborhood
	 * @param s the simulation in which the event occurs
	 */
	...
	/**
	 * An event is distributed with uniform probability. And event can occur with
	 * the same probability in each cell of the grid.
	 * 
	 * @param probability the probability of the event occurring in each cell
	 * @param s simulation in which the event occurs
	 */
	...
	/**
	 * An event is distributed in a rectangular shape according to the coordinates of
	 * two cells, (r1,c1) and (r2,c2). The event occurs in all involved cells.
	 * 
	 * @param r1 row of the first cell
	 * @param c1 column of the fist cell
	 * @param r2 row of the second cell
	 * @param c2 column of the second cell
	 * @param s simulation in which the event occur
	 */
	...
	/**
	 * This method parses an event that is represented in a string, that is useful
	 * for console use. The first one or two characters describes the type of event,
	 * and the rest represent the distribution in which the event happens.  
	 * 
	 * @param s the string that represent the event
	 * @return the parsed event
	 * @throws IllegalArgumentException when the string doesn't comply the event 
	 * representation.
	 */
