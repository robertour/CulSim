...
/**
 * This class represent the shape in which an event is distributed. The 
 * name Distribution might get confusion with probabilistic distribution.
 * Although there is some relation with it, it shouldn't be interpreted 
 * strictly since some of the distributions might actually be deterministic.
 * 
 ...
 * distributed in a Neumann neighborhood; and RECTANGULAR, in which the 
 * events are distributed in a rectangle.
 * 
...
public class Distribution implements Serializable{
	...
	/**
	 * A row that indicates one position where the event is located 
	 * represented as a ratio of the total rows to keep the events scalable 
	 * across different word sizes. For NEUMANN and NORMAL distributions,
	 * it represent the row in which the event is centered. For RECTANGULAR
	 * distribution, it represents the row of the initial position of the 
	 * rectangle. 
	 */
	 ...
	 * across different word sizes.  For NEUMANN and NORMAL distributions,
	 * it represent the column in which the event is centered. For RECTANGULAR
	...
	/**
	 * For RECTANGULAR distribution, it represents the column of the final position 
	 * of the rectangle. 
	 */
	 ...
	 * @param probability the probability of the event to occur in any particular
	 * cell.
	 */
	 ...
	 * @param row_ratio the initial row of the event (as a ratio of the rows)
	 * @param col_ratio the initial column of the event (as a ratio of the columns)
	 * @param row2_ratio the final row of the event (as a ratio of the rows)
	 * @param col2_ratio the final column of the event (as a ratio of the columns)
	 */
	 ...
	 * @param row_ratio the center row of the event (as a ratio of the rows)
	 * @param col_ratio the center column of the event (as a ratio of the columns)
	 * @param sd the standard deviation used to distribute the probabilities
	 */
	 ...
	 * @param row_ratio the center row of the event (as a ratio of the rows)
	 * @param col_ratio the center column of the event (as a ratio of the columns)
	 * @param r the radius of the NEUMANN distribution
	 */
	 ...
	 * for RECTANGULAR) of the event according to the world size of the simulation.
	 * @param sim the simulation in which the event is executed
	...
	/**
	 * Calculates the exact column (center for UNIFORM or NEUMAN, initIal position
	 * for RECTANGULAR) of the event according to the world size of the simulation.
	 * @param sim the simulation in which the event is executed
	 * @return the exact column depending on the number of columns of the simulation
	 */
	...
	/**
	 * Calculates the exact row (final position for RECTANGULAR) of the event according 
	 * to the world size of the simulation.
	 * @param sim the simulation in which the event is executed
	 * @return the exact row depending on the number of rows of the simulation
	 */
	...
	/**
	 * Calculates the exact column (final position for RECTANGULAR) of the event according 
	 * to the world size of the simulation.
	 * @param sim the simulation in which the event is executed
	 * @return the exact column depending on the number of columns of the simulation
	 */
	...
	/** 
	 * Return the standard deviation of the distribution (for NORMAL distribution only)
	...
	/**
	 * Returns a NormalProbabilityDensityFuntion to calculate the way in which the event
	 * is distributed for the NORMAL distribution
	 * @param s the simulation in which the event will be executed
	 * @return the NormalProbabilityDensityFuntion describing how the event will be 
	 * distributed
	 */
	...
	public class NormalProbabilityDensityFuntion implements Serializable{
		...
		/**
		 * Constructor
		 * @param sd the standard distribution of the normal distribution.
		 */
	 ...
	 * @return an instance of the Distribution class that represent
	 * the distribution represented in the string s
	 */
